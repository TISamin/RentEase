import { c as createLucideIcon, a as useParams, b as useNavigate, u as useAuth, r as reactExports, j as jsxRuntimeExports, L as Link, B as Button, d as Users, e as ue } from "./index-BXEpZzQv.js";
import { A as AlertDialog, a as AlertDialogTrigger, T as Trash2, b as AlertDialogContent, c as AlertDialogHeader, d as AlertDialogTitle, e as AlertDialogDescription, f as AlertDialogFooter, g as AlertDialogCancel, h as AlertDialogAction, S as Skeleton } from "./skeleton-fS7VzXjV.js";
import { B as Badge } from "./badge-Bs8Yw0hg.js";
import { e as useGetListing, f as useDeleteListing, M as MapPin, d as CATEGORY_LABELS, g as CATEGORY_COLORS, b as Card, c as CardContent, P as Phone } from "./useBackend-BwHj800f.js";
/**
...
function GalleryImage({ imageKey, alt, className, onClick, isActive }) {
    return (
...
function ListingDetail() {
    ...
    if (isLoading)
        return /* @__PURE__ */ jsxRuntimeExports.jsx(ListingDetailSkeleton, {});
    if (error || !listing) {
        return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", {
    ...
    const datePosted = new Date(Number(listing.createdAt) / 1e6).toLocaleDateString("en-US", {
        year: "numeric",
        month: "long",
        day: "numeric"
    });
    const isOwner = userId != null && listing.owner === userId;
    ...
    return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "bg-background min-h-screen", "data-ocid": "listing_detail.page", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container mx-auto px-4 sm:px-6 py-8 max-w-5xl", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between mb-6 gap-4", children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/browse", "data-ocid": "listing_detail.back.link", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Button, {
                                type: "button",
                                variant: "ghost",
                                size: "sm",
                        ...
                        isOwner && /* @__PURE__ */ jsxRuntimeExports.jsx("div", {
                            ...
                            children: /* @__PURE__ */ jsxRuntimeExports.jsxs(AlertDialog, { open: deleteOpen, onOpenChange: setDeleteOpen, children: [
                                    /* @__PURE__ */ jsxRuntimeExports.jsx(AlertDialogTrigger, { asChild: true, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Button, {
                                            type: "button",
                                            variant: "destructive",
                                            size: "sm",
                                            className: "gap-2",
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 md:grid-cols-3 gap-8", children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "md:col-span-2 flex flex-col gap-6", children: [
                                /* @__PURE__ */ jsxRuntimeExports.jsx("div", {
                                    ...
                                    children: hasImages ? /* @__PURE__ */ jsxRuntimeExports.jsx(GalleryImage, {
                                ...
                                imageKeys.length > 1 && /* @__PURE__ */ jsxRuntimeExports.jsx("div", {
                                    className: "grid grid-cols-4 sm:grid-cols-5 gap-2",
                                    "data-ocid": "listing_detail.thumbnails.list",
                                    children: imageKeys.map((key, i) => /* @__PURE__ */ jsxRuntimeExports.jsx("button", {
                                        type: "button",
                                        ...
                                        children: /* @__PURE__ */ jsxRuntimeExports.jsx(GalleryImage, {
                                            imageKey: key,
                                ...
                                (parsedMetadata == null ? void 0 : parsedMetadata.currentRoommates) && parsedMetadata.currentRoommates.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "pt-6 border-t border-border mt-2", children: [
                                        ...
                                        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 sm:grid-cols-2 gap-4", children: parsedMetadata.currentRoommates.map((rm, idx) => /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "overflow-hidden border border-border shadow-sm", children: [
                                                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-row items-center p-4 gap-4 bg-muted/20", children: [
                                                            rm.photoData ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-16 w-16 rounded-full overflow-hidden border-2 border-background shadow-sm shrink-0", children: /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: rm.photoData, alt: rm.name, className: "h-full w-full object-cover" }) }) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-16 w-16 rounded-full bg-muted flex items-center justify-center border-2 border-background shadow-sm shrink-0", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Users, { className: "h-8 w-8 text-muted-foreground/50" }) }),
                                                            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex-1 min-w-0", children: /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-semibold text-foreground truncate", children: rm.name }) })
                                                        ] }),
                                                    /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { className: "p-4 pt-3 border-t border-border/50", children: /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-foreground/80 leading-relaxed whitespace-pre-line", children: rm.description }) })
                                                ] }, idx)) })
                                    ] })
                            ] }),
                        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-col gap-4", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Card, {
                                ...
                                children: /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { className: "p-5 flex flex-col gap-5", children: [
                                        ...
                                        parsedMetadata && parsedMetadata.roommatesNeeded != null && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "border-t border-border pt-4 grid grid-cols-2 gap-2 text-sm", children: [
                                                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col gap-1", children: [
                                                        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-muted-foreground text-xs uppercase tracking-wider font-semibold", children: "Needed" }),
                                                ...
                                                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col gap-1", children: [
                                                        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-muted-foreground text-xs uppercase tracking-wider font-semibold", children: "Current" }),
                                                        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1.5 font-medium", children: [
                                                                /* @__PURE__ */ jsxRuntimeExports.jsx(Users, { className: "h-4 w-4 text-accent" }),
                                        ...
                                        /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: `tel:${listing.contactPhone}`, className: "block", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Button, {
                                                type: "button",
