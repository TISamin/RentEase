...
import { V as Subscribable, Y as pendingThenable, Z as resolveQueryBoolean, _ as shallowEqualObjects, $ as resolveStaleTime, a0 as noop, a1 as environmentManager, a2 as isValidTimeout, a3 as timeUntilStale, a4 as timeoutManager, a5 as focusManager, a6 as fetchState, a7 as replaceData, a8 as notifyManager, a9 as hashKey, aa as getDefaultState, r as reactExports, ab as shouldThrowError, ac as useQueryClient, c as createLucideIcon, j as jsxRuntimeExports, g as cn, ad as useAuthStore } from "./index-BXEpZzQv.js";
    ...
    createResult(query, options) {
        ...
        if (options.placeholderData !== void 0 && data === void 0 && status === "pending") {
            ...
            if ((prevResult == null ? void 0 : prevResult.isPlaceholderData) && options.placeholderData === (prevResultOptions == null ? void 0 : prevResultOptions.placeholderData)) {
                ...
                placeholderData = typeof options.placeholderData === "function" ? options.placeholderData((_a2 = __privateGet(this, _lastQueryWithDefinedData)) == null ? void 0 : _a2.state.data, __privateGet(this, _lastQueryWithDefinedData)) : options.placeholderData;
            }
...
function useBaseQuery(options, Observer, queryClient) {
    ...
    (_b2 = (_a2 = client.getDefaultOptions().queries) == null ? void 0 : _a2._experimental_beforeQuery) == null ? void 0 : _b2.call(_a2, defaultedOptions);
    ...
    (_d = (_c = client.getDefaultOptions().queries) == null ? void 0 : _c._experimental_afterQuery) == null ? void 0 : _d.call(_c, defaultedOptions, result);
...
var Category = /* @__PURE__ */ ((Category2) => {
    ...
    Category2["marketplace"] = "marketplace";
    Category2["event_planning"] = "event_planning";
    Category2["decoration_service"] = "decoration_service";
    Category2["maintenance_service"] = "maintenance_service";
    Category2["cleaning_service"] = "cleaning_service";
    Category2["catering_service"] = "catering_service";
    Category2["roommate_finder"] = "roommate_finder";
    return Category2;
})(Category || {});
...
const CATEGORY_COLORS = {
    ...
    ["convention_hall"]: "bg-amber-100 text-amber-800",
    ["shifting_service"]: "bg-rose-100 text-rose-800",
    ["marketplace"]: "bg-orange-100 text-orange-800",
    ["event_planning"]: "bg-pink-100 text-pink-800",
    ["decoration_service"]: "bg-fuchsia-100 text-fuchsia-800",
    ["maintenance_service"]: "bg-teal-100 text-teal-800",
    ["cleaning_service"]: "bg-cyan-100 text-cyan-800",
    ["catering_service"]: "bg-yellow-100 text-yellow-800",
    ["roommate_finder"]: "bg-indigo-100 text-indigo-800"
};
...
export { ALL_CATEGORIES as A, BROWSE_CATEGORIES as B, Category as C, MapPin as M, Phone as P, SERVICE_CATEGORIES as S, useMyProfile as a, Card as b, CardContent as c, CATEGORY_LABELS as d, useGetListing as e, useDeleteListing as f, CATEGORY_COLORS as g, useCreateListing as h, useUpsertProfile as i, CardHeader as j, CardTitle as k, useMyListings as l, useBrowseListings as u };
