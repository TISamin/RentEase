import { r as reactExports, j as jsxRuntimeExports, S as Search, I as Input, B as Button } from "./index-BXEpZzQv.js";
import { L as ListingCardSkeleton, B as Building2, a as ListingCard } from "./ListingCard-CSMUJvLN.js";
import { u as useBrowseListings, C as Category } from "./useBackend-BwHj800f.js";
...
function Marketplace() {
    ...
    const filter = {
        searchQuery: debouncedSearch.trim() || void 0,
    ...
    return /* @__PURE__ */ jsxRuntimeExports.jsxs("main", { className: "min-h-screen bg-background", "data-ocid": "marketplace.page", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "bg-card border-b border-border", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container mx-auto px-4 sm:px-6 py-8 sm:py-10", children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-5", children: [
                                /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "font-display text-2xl sm:text-3xl font-bold text-foreground leading-tight", children: "Marketplace" }),
                                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground text-sm sm:text-base mt-1", children: "Find used furniture, appliances, and items for your home." })
                            ] }),
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "container mx-auto px-4 sm:px-6 py-8", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between mb-6 min-h-6 gap-2", children: [
                            ...
                            hasActiveFilters && /* @__PURE__ */ jsxRuntimeExports.jsx(Button, {
                                type: "button",
                                variant: "ghost",
                                size: "sm",
                    ...
                    isError && !isLoading && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", {
                        className: "flex flex-col items-center justify-center py-20 gap-3 text-center",
                        "data-ocid": "browse.error_state",
                        role: "alert",
                        children: [
                            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "rounded-full bg-destructive/10 p-5", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Building2, {
                    ...
                    !isLoading && !isError && (listings == null ? void 0 : listings.length) === 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", {
                        className: "flex flex-col items-center justify-center py-20 gap-4 text-center",
                        "data-ocid": "browse.empty_state",
                        children: [
                            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "rounded-full bg-muted p-5", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Building2, {
                    ...
                    !isLoading && !isError && listings && listings.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("div", {
                        className: "grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5",
                        "data-ocid": "browse.list",
                        children: listings.map((listing, index) => /* @__PURE__ */ jsxRuntimeExports.jsx(ListingCard, {
                            listing,
                            index
                        }, listing.id.toString()))
                    })
