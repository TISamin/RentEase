import { c as createLucideIcon, u as useAuth, j as jsxRuntimeExports, L as Link, B as Button, U as User, S as Search, H as House } from "./index-CYfAcN1s.js";
import { B as Badge } from "./badge-Vd0Oa7Rj.js";
import { u as useBrowseListings, a as useMyProfile, C as Category, b as Card, c as CardContent, d as CATEGORY_LABELS, M as MapPin } from "./useBackend-DhQTVAua.js";
import { B as Building2, L as ListingCardSkeleton, a as ListingCard } from "./ListingCard-BJ7rVy4H.js";
/**
      ...
      "div",
      {
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container mx-auto px-4 sm:px-6 py-3 flex flex-col sm:flex-row items-center justify-between gap-3", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 shrink-0", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/profile", "data-ocid": "home.welcome_profile.link", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
              Button,
              {
                type: "button",
                variant: "ghost",
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/post-listing", "data-ocid": "home.welcome_post.link", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
              Button,
              {
                type: "button",
                size: "sm",
        ...
        children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "relative container mx-auto px-4 sm:px-6 py-16 md:py-24", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-2xl", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col sm:flex-row gap-3", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/browse", "data-ocid": "home.browse_cta.button", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
                Button,
                {
                  type: "button",
                  size: "lg",
      ...
      "section",
      {
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container mx-auto px-4 sm:px-6", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-end justify-between mb-8", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/browse", "data-ocid": "home.browse_all_categories.link", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
              Button,
              {
                type: "button",
                variant: "ghost",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-2 md:grid-cols-4 gap-4", children: BROWSE_CATEGORIES.map(
            ({ category, icon: Icon, description, bgClass }) => /* @__PURE__ */ jsxRuntimeExports.jsx(
              Link,
              {
                to: "/browse",
                search: { category },
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "section",
      {
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container mx-auto px-4 sm:px-6", children: [
          ...
          ].map(({ icon: Icon, step, title, desc }) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
      ...
      "section",
      {
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container mx-auto px-4 sm:px-6", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-end justify-between mb-8", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/browse", "data-ocid": "home.view_all.link", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
              Button,
              {
                type: "button",
                variant: "ghost",
          ...
          ) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6", children: featured.map((listing, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
            ListingCard,
            {
              listing,
              index: i
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "section",
      {
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container mx-auto px-4 sm:px-6 text-center max-w-xl", children: [
          ...
          isAuthenticated ? /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/post-listing", "data-ocid": "home.cta_post_listing.button", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
            Button,
            {
              type: "button",
              size: "lg",
