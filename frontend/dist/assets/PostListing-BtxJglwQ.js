import { c as createLucideIcon, r as reactExports, j as jsxRuntimeExports, f as createSlot, g as cn, b as useNavigate, I as Input, d as Users, h as Label, i as LoaderCircle, X, B as Button, e as ue } from "./index-CYfAcN1s.js";
import { B as Badge } from "./badge-Vd0Oa7Rj.js";
import { h as useCreateListing, A as ALL_CATEGORIES, b as Card, c as CardContent, d as CATEGORY_LABELS, M as MapPin, P as Phone, C as Category } from "./useBackend-DhQTVAua.js";
...
function PostListing() {
  ...
  const [roommatesGot, setRoommatesGot] = reactExports.useState("0");
        ...
        try {
          await new Promise((resolve) => {
            ...
            const interval = setInterval(() => {
              ...
              setImages(
                (prev) => prev.map(
                  (i) => i.id === img.id ? { ...i, progress: Math.min(pct, 100) } : i
                )
              );
            }, 120);
          });
          ...
          setImages(
            (prev) => prev.map(
              (i) => i.id === img.id ? { ...i, status: "done", progress: 100, imageKey } : i
            )
          );
          ...
          setImages(
            (prev) => prev.map(
              (i) => i.id === img.id ? { ...i, status: "error", progress: 0 } : i
            )
          );
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-background min-h-screen", "data-ocid": "post_listing.page", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "container mx-auto px-4 sm:px-6 py-8 max-w-2xl", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Card, { className: "border border-border shadow-sm", children: /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { className: "p-6 md:p-8", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "form",
      {
        ...
        children: [
          ...
          isRoommateFinder && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-2 gap-4", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              FieldWrapper,
              {
                id: "roommates-needed",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col gap-3", children: [
            ...
            images.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "div",
              {
                ...
                children: [
                  images.map((img, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
                    "div",
                    {
                      ...
                      children: [
                        ...
                        img.status === "error" && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 flex items-center justify-center bg-destructive/20", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                          Badge,
                          {
                            variant: "destructive",
