...
var L = 55799;
var R = Symbol("CBOR_STOP_CODE");
var u = ((t) => (t[t.False = 20] = "False", t[t.True = 21] = "True", t[t.Null = 22] = "Null", t[t.Undefined = 23] = "Undefined", t[t.Break = 31] = "Break", t))(u || {});
...
var P = 65535;
var H = 4294967295;
var W = BigInt("0xffffffffffffffff");
var f = ((t) => (t[t.Value = 23] = "Value", t[t.OneByte = 24] = "OneByte", t[t.TwoBytes = 25] = "TwoBytes", t[t.FourBytes = 26] = "FourBytes", t[t.EightBytes = 27] = "EightBytes", t[t.Indefinite = 31] = "Indefinite", t))(f || {});
var l = false;
function K(t) {
  return t == null;
}
...
function p(t, e) {
  ...
  if (n === 1 / 0) {
    ...
    let i = B(e);
    for (; i !== R; )
      o.push((e == null ? void 0 : e(i)) ?? i), i = B(e);
    return o;
  }
  const s = new Array(n);
  for (let o = 0; o < n; o++) {
    const i = B(e);
    s[o] = (e == null ? void 0 : e(i)) ?? i;
  }
  return s;
}
function b(t) {
...
function j(t, e) {
  ...
  if (n === 1 / 0) {
    ...
    for (; o !== c.Simple && i !== u.Break; ) {
      const A = F(i), I = B(e);
      s[A] = (e == null ? void 0 : e(I, A)) ?? I, [o, i] = N();
    }
    return s;
  }
  for (let o = 0; o < n; o++) {
...
function invert(number, modulo) {
  ...
  while (a2 !== _0n2) {
    ...
    const m2 = x2 - u2 * q2;
    const n = y2 - v2 * q2;
    b2 = a2, a2 = r2, x2 = u2, y2 = v2, u2 = m2, v2 = n;
  }
  const gcd = b2;
  if (gcd !== _1n2)
...
function SWUFpSqrtRatio(Fp4, Z2) {
  const q2 = Fp4.ORDER;
  let l2 = _0n4;
  for (let o = q2 - _1n4; o % _2n2 === _0n4; o /= _2n2)
    l2 += _1n4;
  const c1 = l2;
...
function mapToCurveSimpleSWU(Fp4, opts) {
  ...
  if (!Fp4.isValid(A) || !Fp4.isValid(B2) || !Fp4.isValid(Z2))
  ...
  return (u2) => {
    ...
    const e1 = Fp4.isOdd(u2) === Fp4.isOdd(y2);
...
function edwards(params, extraOpts = {}) {
  ...
  const uvRatio2 = extraOpts.uvRatio || ((u2, v2) => {
    try {
      return { isValid: true, value: Fp4.sqrt(Fp4.div(u2, v2)) };
    } catch (e) {
...
function eddsa(Point, cHash, eddsaOpts = {}) {
  ...
  function sign(msg, secretKey, options = {}) {
    ...
    const s = Fn2.create(r2 + k2 * scalar);
    if (!Fn2.isValid(s))
  ...
  const utils = {
    ...
    toMontgomery(publicKey) {
      ...
      const u2 = is25519 ? Fp4.div(_1n8 + y2, _1n8 - y2) : Fp4.div(y2 - _1n8, y2 + _1n8);
      return Fp4.toBytes(u2);
    },
...
var _RistrettoPoint = class __RistrettoPoint extends PrimeEdwardsPoint {
  ...
  static fromBytes(bytes) {
    ...
    if (!equalBytes(Fp3.toBytes(s), bytes) || isNegativeLE(s, P2))
...
@noble/curves/esm/ed25519.js:
  (*! noble-curves - MIT License (c) 2022 Paul Miller (paulmillr.com) *)
*/
//# sourceMappingURL=chunk-PFETW3TI.js.map
